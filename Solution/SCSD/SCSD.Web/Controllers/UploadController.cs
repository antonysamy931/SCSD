        ...
        public ActionResult UserUpload(HttpPostedFileBase Baner, HttpPostedFileBase FileContent)
        {
            ...
            if (FileContent != null)
            {
                if (FileContent.ContentLength != 0)
                {
                    ...
                    uploadFile.FileCheckSum = CheckSumGenerator.GetCheckSum(FileContent.InputStream);
                    ...
                    {
                        uploadFile.FileContent = SymmetricEncryption.Encrypt(CheckSumGenerator.GetByteFromStream(FileContent.InputStream, FileContent.ContentLength), uploadFile.SymmeticKey);
